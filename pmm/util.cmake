...
function(_pmm_timestamp_file name place duration)
    set(__status FALSE)
    if (place EQUAL "LOCAL")
        set(__file "${PMM_DIR}/${name}-stamp.txt")
    elseif (place EQUAL "LOCAL_VERSION")
        set(__file "${PMM_DIR_BASE}/${name}-stamp.txt")
    elseif (place EQUAL "GLOBAL")
        set(__file "${_PMM_GLOBAL_USER_DATA_DIR}/${name}-stamp.txt")
    elseif (place EQUAL "VERSION")
        set(__file "${_PMM_USER_DATA_DIR}/${name}-stamp.txt")
    else ()
        message(FATAL_ERROR "Unknown ${place}")
    endif ()
    ...
    set(${name} "${do_write}" PARENT_SCOPE)
endfunction()